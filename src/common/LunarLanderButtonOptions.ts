...
export const LIGHT_SURFACE_TEXT_FILL = LunarLanderColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link LunarLanderColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: LunarLanderColors.controlSurfaceColorProperty,
  listFill: LunarLanderColors.controlSurfaceColorProperty,
  buttonStroke: LunarLanderColors.panelBorderColorProperty,
  listStroke: LunarLanderColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: LunarLanderColors.textColorProperty },
  },
